...
var topFiveProductsBestSelling = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.topFiveProductsBestSelling()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
...
var topfiveProductMostExpensive = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.topfiveProductMostExpensive()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
