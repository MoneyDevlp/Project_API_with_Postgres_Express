...
var DashboardQueries = /** @class */ (function () {
    ...
    DashboardQueries.prototype.topFiveProductsBestSelling = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = "select p.name, p.price, sum(o.quantity) as totalQuantity, count(o.product_id) as totalProductOrder from products p inner join order_products o on p.id = o.product_id group by p.name, p.price order by totalProductOrder desc limit 5";
    ...
    DashboardQueries.prototype.topfiveProductMostExpensive = function () {
        return __awaiter(this, void 0, void 0, function () {
